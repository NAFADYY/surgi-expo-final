...
import "./ProductPageRandom.css"
import Footer from '../Footer/Footer';

export default function ProductPageRandom() {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                const response = await axios.get(`https://api.surgi-expo.com/api/products?page=${currentPage}&limit=${productsPerPage}`);
